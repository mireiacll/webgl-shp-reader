...
export class MireiaLineLoop {
  ...
  constructor(points, color = null) {
    ...
    const node = new MireiaNode([mesh], this.#transform, 'LINE_LOOP'); // GL_LINE_LOOP (draw mode) auto-closes last point back to first
  ...
  getDrawMode(gl) { return gl.LINE_LOOP; }
